function createPlanner(){
  ...
  //added to allign calendar with events
  // $('#external-events').css('margin-top',"3em");// scalable version
  $('#external-events').append("<h4>My Point of Interest</h4>");
  ...
  $(wrapper).css("background-color", "rgba(214, 245, 142, 0.9)");
