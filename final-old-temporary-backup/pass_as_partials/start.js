function loadStart() {
  ...
  $("#formContainer").append("<form id='form' style='background-color: rgba(214, 245, 142, 0.9)'></form>");
  ...
  $('#form').append("<button class='submit'>Submit</button>").click(function () { $(".submit").submit(); });
